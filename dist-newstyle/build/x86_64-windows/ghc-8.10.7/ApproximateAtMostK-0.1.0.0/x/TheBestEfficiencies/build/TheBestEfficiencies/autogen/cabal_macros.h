...
/* package ApproximateAtMostK-0.1.0.0 */
#ifndef VERSION_ApproximateAtMostK
#define VERSION_ApproximateAtMostK "0.1.0.0"
#endif /* VERSION_ApproximateAtMostK */
#ifndef MIN_VERSION_ApproximateAtMostK
#define MIN_VERSION_ApproximateAtMostK(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ApproximateAtMostK */
...
#define CURRENT_COMPONENT_ID "ApproximateAtMostK-0.1.0.0-inplace-TheBestEfficiencies"
